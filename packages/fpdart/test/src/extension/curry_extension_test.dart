...
void main() {
  group('Curry/Uncarry extension', () {
    ...
    group('Curry/Uncarry (3)', () {
      ...
      int Function(int) Function(int) subtractCurried(int n1) =>
          (n2) => (n3) => n1 - n2 - n3;
      ...
      Glados3<int, int, int>(any.int, any.int, any.int).test('uncurry',
          (n1, n2, n3) {
        expect(
            subtractCurried(n1)(n2)(n3), subtractCurried.uncurry(n1, n2, n3));
      });
    });

    group('Curry/Uncarry (4)', () {
      int subtract(int n1, int n2, int n3, int n4) => n1 - n2 - n3 - n4;
      int Function(int) Function(int) Function(int) subtractCurried(int n1) =>
      ...
      Glados3<int, int, int>(any.int, any.int, any.int).test('uncurry',
          (n1, n2, n3) {
        expect(subtractCurried(n1)(n2)(n3)(n1),
            subtractCurried.uncurry(n1, n2, n3, n1));
      });
    });
    ...
    group('Curry/Uncarry (5)', () {
      ...
      Glados3<int, int, int>(any.int, any.int, any.int).test('uncurry',
          (n1, n2, n3) {
        expect(subtractCurried(n1)(n2)(n3)(n1)(n2),
            subtractCurried.uncurry(n1, n2, n3, n1, n2));
      });
    });
  });
}
